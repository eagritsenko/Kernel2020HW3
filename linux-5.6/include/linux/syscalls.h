...
/* tchardev */
asmlinkage long sys_get_user(struct user_entry* at, const char *surname, const char *name);
asmlinkage long sys_insert_user(struct user_entry *entry);
asmlinkage long sys_del_user(char *surname, char *name);
